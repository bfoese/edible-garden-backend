...
describe('Botanical Family Entity', () => {
  ...
  let botanicalFamily: BotanicalFamily;

  let i18nData: BotanicalFamilyI18n[];
  let originalI18nDataLength: number;

  beforeEach(async () => {
    i18nData = [
      TestObjectFactory.of(BotanicalFamilyI18n, {
    ...
    botanicalFamily = TestObjectFactory.of(BotanicalFamily, {
